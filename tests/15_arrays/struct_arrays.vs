...
func test_struct_array_push() test -> Expected(int32, "1") {
    var players: []Player = []
    players.push(Player{
        id:       1,
...
func test_struct_array_field_write() test -> Expected(int32, "50") {
    var players: []Player = []
    players.push(Player{id: 1, position: Vec2{x: 0.0, y: 0.0}, health: 100})
    players[0].health = 50
    return players[0].health
...
func test_struct_array_nested_field_read() test -> Expected(float32, "1.000000") {
    var players: []Player = []
    players.push(Player{id: 2, position: Vec2{x: 1.0, y: 1.0}, health: 80})
